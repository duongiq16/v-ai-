...
class Game:
    def __init__(self):
        ...
        self.FPS = 100      # Số cảnh mỗi giây (frame per second)
    ...
    def start(self):
        ...
        while running:
            ...
            if not end_game:
                ...
                if pressed[pygame.K_UP]:    trau.move( 0, -50)
                if pressed[pygame.K_DOWN]:  trau.move( 0,  50)
                if pressed[pygame.K_LEFT]:  trau.move(-50,  0)
                if pressed[pygame.K_RIGHT]: trau.move( 50,  0)
                #if pressed[pygame.k_Ctrl] and pressed[pygame.k_c]
